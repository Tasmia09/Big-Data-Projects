...
def model_at_point(x, Independent_Data, Dependent_Data, K, model="KNN"): 

            ### Find Nearest neighbors
            indices_of_nearest_neighbors = indices_of_kNN(Independent_Data, x[:2], K)
...
### model is one of ["HYPPO", "KNN", "SBM"]. KNN is the default, as the current
...
def main(input1, input2, depIndex=2, model="KNN", k=6):
    ...
    for line in input1:
        ...
        Independent_Data.append(numbers)
    ...
    for x in input2:
        ...
        z = model_at_point(x, Independent_Data, Dependent_Data, K, model) 
        
        output.append([x[0], x[1], z])
...
if __name__ == "__main__":    
    ...
    parser.add_argument( "-m", "--model", 
                         ...
                         choices=["HYPPO", "KNN", "SBM"], default="KNN")
    ...
    output = main(original_values, values_to_model, depIndex=args.depIndex, model=args.model, k=args.k)
